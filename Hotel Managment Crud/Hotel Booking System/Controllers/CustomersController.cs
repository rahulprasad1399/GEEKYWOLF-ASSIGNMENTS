...
namespace Hotel_Booking_System.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> CreateCustomer(CustomerPostDto customerPostDto)
        {
        ...
        {
            List<CustomersGetAll> customers = await _customerService.GetAllCustomers();
            return Ok(customers);
        }
        ...
        {
            CustomersGetAll customer = await _customerService.GetCustomer(id);
            if (customer == null)
            {
                return NotFound();
            }
